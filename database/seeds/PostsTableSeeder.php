    ...
    public function run()
    {
        ...
        if (!$post->exists) {
            $post->fill([
                ...
                'image'            => 'http://default-environment.rjmxmqm47p.us-east-2.elasticbeanstalk.com//posts/post1.jpg',
        ...
        if (!$post->exists) {
            $post->fill([
                ...
                'image'            => 'http://default-environment.rjmxmqm47p.us-east-2.elasticbeanstalk.com/posts/post2.jpg',
                'slug'             => 'my-sample-post',
        ...
        if (!$post->exists) {
            $post->fill([
                ...
                'image'            => 'http://default-environment.rjmxmqm47p.us-east-2.elasticbeanstalk.com/posts/post3.jpg',
                'slug'             => 'latest-post',
                'meta_description' => 'This is the meta description',
                'meta_keywords'    => 'keyword1, keyword2, keyword3',
                'status'           => 'PUBLISHED',
...
<p>Interloper heave down list driver pressgang holystone scuppers tackle scallywag bilged on her anchor. Jack Tar interloper draught grapple mizzenmast hulk knave cable transom hogshead. Gaff pillage to go on account grog aft chase guns piracy yardarm knave clap of thunder.</p>',
                'image'            => 'http://default-environment.rjmxmqm47p.us-east-2.elasticbeanstalk.com/posts/post4.jpg',
                'slug'             => 'yarr-post',
